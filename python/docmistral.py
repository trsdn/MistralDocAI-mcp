...
try:
    # mistralai >= 2 moved the SDK into the client subpackage.
    from mistralai.client import Mistral
except ImportError:  # pragma: no cover - mistralai 1.x layout
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": (
                                    "Please extract all text from this image. Format the output "
                                    "as clean text without any additional explanations."
                                )
                            },
                            {
                                "type": "image_url",
...
def main():
    parser = argparse.ArgumentParser(
        description='DocMistral - Convert documents and images to Markdown using Mistral AI'
    )
